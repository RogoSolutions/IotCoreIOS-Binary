...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/RogoSolutions/IotCoreIOS-Binary/releases/download/0.9.4-test/IotCoreIOS-0.9.4-test.xcframework.zip",
            checksum: "38fcb35a47e8f3e4cfdf0e40ebe07975d5fe25d108f60ccdacc7f77a605d4354"
        ),
